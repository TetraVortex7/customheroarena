...
_G.XP_PER_LEVEL_TABLE = {100}
for i=2,MAX_LEVEL do 
XP_PER_LEVEL_TABLE[i] = XP_PER_LEVEL_TABLE[i-1] + 60 * i
end
...
for i=1,100 do 
	HERO_RESPAWN_TIME_PER_LEVEL[i] = i * 0.1 + 5
end
...
MaimEffects = LoadKeyValues("scripts/npc/KV/MaimEffects.kv")
NOT_REFLECTABLE_ABILITIES = LoadKeyValues("scripts/npc/KV/NotReflectableAbilities.kv")
ItemsAndAbilityLocalisation = LoadKeyValues("scripts/npc/KV/ItemsAndAbilityLocalisation.kv")