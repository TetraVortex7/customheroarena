...
LinkLuaModifier("untouchable_custom_passive","heroes/hero_enchantress/untouchable_custom.lua",LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("untouchable_custom_slow","heroes/hero_enchantress/untouchable_custom.lua",LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("untouchable_custom_slow_scepter","heroes/hero_enchantress/untouchable_custom.lua",LUA_MODIFIER_MOTION_NONE)
