function modifier_item_heart3_regen_on_take_damage(keys)
	...
	if	keys.caster:HasModifier("modifier_item_heart3_regen_visible") then
		keys.caster:RemoveModifierByNameAndCaster("modifier_item_heart3_regen_visible", keys.caster)
	end
end

function modifier_item_heart3_regen_on_cast_spell(keys)
...
function modifier_item_heart3_regen_on_interval_think(keys)
	...
	elseif	keys.caster:HasModifier("modifier_item_heart3_regen_visible") then
		keys.caster:RemoveModifierByNameAndCaster("modifier_item_heart3_regen_visible", keys.caster)
	end
end


function modifier_item_heart3_regen_on_destroy(keys)
	keys.caster:RemoveModifierByNameAndCaster("modifier_item_heart3_regen_visible", keys.caster)
end	