...
LinkLuaModifier("modifier_alebard_passive","items/item_alebard.lua",LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_alebard_disarm","items/item_alebard.lua",LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_alebard_traum","items/item_alebard.lua",LUA_MODIFIER_MOTION_NONE)
